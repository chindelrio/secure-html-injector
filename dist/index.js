...
var HtmlInjector = function HtmlInjector(_ref) {
  ...
  var domNodeToReact = React.useCallback(function (node) {
    ...
    if (node.nodeType === Node.ELEMENT_NODE) {
      ...
      return React.createElement.apply(void 0, [el.tagName.toLowerCase(), props].concat(children));
    }
    return null;
  }, [formatStyles]);
  var parseHtmlToReact = React.useCallback(function (stringToParse) {
  ...
  return parsedHtml ? React__default.createElement("div", null, parsedHtml, " ") : null;
};
